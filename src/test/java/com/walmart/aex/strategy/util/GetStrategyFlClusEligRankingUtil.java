...
@Slf4j
public class GetStrategyFlClusEligRankingUtil {
    ...
    private static StrategyStyleClusId getStrategyStyleClusId(StrategyFlClusEligRankingId strategyFlClusEligRankingId) {
        ...
        strategyStyleClusId.setStyleNbr("51_2_23_001");
    ...
    private static StrategyCcClusEligRankingId getstrategyCcClusEligRankingId(StrategyStyleClusId strategyStyleClusId) {
        ...
        strategyCcClusEligRankingId.setCcId("51_2_23_001_001");
    ...
    public static List<Lvl3> getLvl3List() {
        ...
        List<SizeProfileDTO> sizeProfileCluster = GetStrategyFlClusEligRankingUtil.getSizeStrategy();
    ...
    public static List<Fineline> getFinelines() {
        ...
        Strategy strategy = new Strategy();
        List<WeatherCluster> weatherClusters = GetStrategyFlClusEligRankingUtil.getWeatherClusterStrategy().orElse(null);
    ...
    public static List<Style> getStyle() {
        ...
        style.setStyleNbr("173_23_01_001");
    ...
    public static List<CustomerChoice> getCustomerChoice() {
        ...
        customerChoice.setCcId("173_23_01_001");
    ...
    private static Set<StrategyMerchCatg> getStrategyMerchCatg(PlanStrategyId planStrategyId){
