...
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "strat_cc_fixture", schema = "dbo")
public class StrategyCcFixture {
    @EmbeddedId
    @EqualsAndHashCode.Include
    private StrategyCcFixtureId strategyCcFixtureId;
    ...
    @JsonIgnore
    private StrategyStyleFixture strategyStyleFixture;

    @Column(name = "adj_max_cc_type_pct")
