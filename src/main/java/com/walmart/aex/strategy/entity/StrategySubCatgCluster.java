...
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "strat_subcatg_clus", schema = "dbo")
public class StrategySubCatgCluster implements Serializable {
    @EmbeddedId
    @EqualsAndHashCode.Include
    private StrategySubCatgClustId strategySubCatgClustId;
