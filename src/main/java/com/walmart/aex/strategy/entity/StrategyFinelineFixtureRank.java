...
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "strat_fl_fixture_rank", schema = "dbo")
public class StrategyFinelineFixtureRank {
    @EmbeddedId
    @EqualsAndHashCode.Include
    private StrategyFinelineFixtureRankId strategyFinelineFixtureRankId;
