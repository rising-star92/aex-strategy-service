...
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "elig_cc_mkt_clus_prog", schema = "dbo")
public class EligCcMktClusProg {

    @EmbeddedId
    @EqualsAndHashCode.Include
    private EligCcMktClusProgId eligCcMktClusProgId;
    ...
    @JsonIgnore
    private EligCcClusProg eligCcClusProg;
