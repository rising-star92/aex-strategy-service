...
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "strat_subcatg_sp_clus", schema = "dbo")
public class StrategySubCategorySPCluster {
    @EmbeddedId
    ...
    @JsonIgnore
    private StrategyMerchCategorySPCluster strategyMerchCatgSPClusters;
    ...
    @OneToMany(mappedBy = "strategySubCatgSpClus", fetch = FetchType.LAZY,
            cascade = CascadeType.ALL, orphanRemoval = true)
    private Set<StrategyFineLineSPCluster> strategyFinelinesSPCluster;
